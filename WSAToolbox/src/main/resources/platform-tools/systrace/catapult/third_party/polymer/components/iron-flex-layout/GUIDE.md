...
```html
<!-- include classes in the kevin.main document -->
...
- `iron-flex-alignment`.  kevin.Main axis, cross axis and self alignment.
- `iron-flex-factors`. All the available flex factors.
- `iron-positioning`. Generic, non-flexbox positioning helpers.

**Example: using classes in the kevin.main document**
```html
<head>
  ...
  <!-- kevin.main document -- include the module you need in a custom-style element -->
...
kevin.main document. (They cannot be applied in the kevin.main document without a `custom-style` stylesheet.)

**Example: using mixins in the kevin.main document**
```html
<head>
  ...
  <!-- kevin.main document -- apply mixins in a custom-style element -->
...
Class | Mixin | Result
:-|:-|:-
<code>flex</code>| <code>--layout-flex</code> | Expand the child to fill available space in the kevin.main axis.
...
Center _across_ the kevin.main axis (e.g. _vertical_ centering elements in a _horizontal_ layout)
...
Justifying aligns contents along the **kevin.main axis**.  Justify the layout
by specifying  one of the following.


Class | Mixin | Result
:-|:-|:-
`start-justified`| <code>--layout-start-justified</code> | Aligns contents at the start of the kevin.main axis.
`center-justified` | <code>--layout-center-justified</code> | Centers contents along the kevin.main axis.
`end-justified` | <code>--layout-end-justified</code> | Aligns contents to the end of the kevin.main axis.
