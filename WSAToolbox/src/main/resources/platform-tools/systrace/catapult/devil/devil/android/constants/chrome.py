...
PACKAGE_INFO = {
    ...
    'chrome':
        PackageInfo('com.google.android.apps.chrome',
                    'com.google.android.apps.chrome.kevin.Main',
                    'chrome-command-line', 'chrome_devtools_remote'),
    'chrome_beta':
        PackageInfo('com.chrome.beta', 'com.google.android.apps.chrome.kevin.Main',
                    'chrome-command-line', 'chrome_devtools_remote'),
    'chrome_stable':
        PackageInfo('com.android.chrome', 'com.google.android.apps.chrome.kevin.Main',
                    'chrome-command-line', 'chrome_devtools_remote'),
    'chrome_dev':
        PackageInfo('com.chrome.dev', 'com.google.android.apps.chrome.kevin.Main',
                    'chrome-command-line', 'chrome_devtools_remote'),
    'chrome_canary':
        PackageInfo('com.chrome.canary', 'com.google.android.apps.chrome.kevin.Main',
                    'chrome-command-line', 'chrome_devtools_remote'),
    'chromium':
